...
export default function Statistics({ setShowStats }: Props) {
  ...
  const avgShorthand = useCheckMobile()
    ? "Avg. guesses"
    : "Durchschnittlich benötigte Antworten";

  const statsTable = [
    { label: "Letzter Sieg", value: showLastWin },
    { label: "Gewonnene Spiele", value: gamesWon },
    { label: "Aktuelle Serie", value: currentStreak },
    { label: "Max Serie", value: maxStreak },
  ...
  function promptReset() {
    setMsg("Sind Sie sicher, dass Sie Ihren Spielstand zurücksetzen wollen?");
    setResetComplete(false);
    setShowResetMsg(true);
  }
  function resetStats() {
    storeStats(firstStats);
    setMsg("Die Statistik wurde gelöscht.");
